...
const navigate = [
  { image: <SvgDashboard />, label: "Dashboard", link: "/admin/dashboard" },
  { image: <SvgProduct />, label: "Products", link: "/admin/products" },
  { image: <SvgCart />, label: "Orders", link: "/admin/orders" },
  { image: <SvgUsers />, label: "Customers", link: "/admin/customers" },
  { image: <SvgEmptyStar />, label: "Reviews", link: "/admin/reviews" },
  { image: <SvgSettings />, label: "Settings", link: "/admin/settings" },
];

export const AdminSidebar = () => {
  return (
    <div className="bg-white-900 text-black-500 h-screen">
      <Link
        to={"/"}
